      		...
      		<div class="modal-content">
        		...
        		<div class="modal-body">
                    ...
                    <div class="form-group">
                        <div class="row">
                            <div class="col-md-6">
                                <label>Teacher Course <span class="text-danger">*</span></label>
                                <input type="text" name="doctor_degree" id="doctor_degree" class="form-control" required data-parsley-trigger="keyup" />
                            </div>
                            <div class="col-md-6">
                                <label>Teacher Department <span class="text-danger">*</span></label>
    ...
    $(document).on('click', '.view_button', function(){
        ...
        $.ajax({
            ...
            success:function(data)
            {
                ...
                html += '<tr><th width="40%" class="text-right">Teacher Email Address</th><td width="60%">'+data.doctor_email_address+'</td></tr>';

                html += '<tr><th width="40%" class="text-right">Teacher Password</th><td width="60%">'+data.doctor_password+'</td></tr>';

                html += '<tr><th width="40%" class="text-right">Teacher Name</th><td width="60%">'+data.doctor_name+'</td></tr>';

                html += '<tr><th width="40%" class="text-right">Teacher Phone No.</th><td width="60%">'+data.doctor_phone_no+'</td></tr>';

                html += '<tr><th width="40%" class="text-right">Teacher Address</th><td width="60%">'+data.doctor_address+'</td></tr>';

                html += '<tr><th width="40%" class="text-right">Teacher Date of Birth</th><td width="60%">'+data.doctor_date_of_birth+'</td></tr>';
                html += '<tr><th width="40%" class="text-right">Teacher Course</th><td width="60%">'+data.doctor_degree+'</td></tr>';

                html += '<tr><th width="40%" class="text-right">Teacher Department</th><td width="60%">'+data.doctor_expert_in+'</td></tr>';
