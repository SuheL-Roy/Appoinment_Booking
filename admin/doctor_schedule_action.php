...
if(isset($_POST["action"]))
{
	...
	if($_POST["action"] == 'Add')
	{
		...
		$success = '<div class="alert alert-success">Teacher Schedule Added Successfully</div>';
	...
	if($_POST["action"] == 'Edit')
	{
		...
		$success = '<div class="alert alert-success">Teacher Schedule Data Updated Successfully Updated</div>';
	...
	if($_POST["action"] == 'change_status')
	{
		...
		echo '<div class="alert alert-success">Teacher Schedule Status change to '.$_POST['next_status'].'</div>';
	}
