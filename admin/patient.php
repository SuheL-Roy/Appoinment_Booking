        ...
        $(document).on('click', '.view_button', function() {
            ...
            $.ajax({
                ...
                success: function(data) {
                    ...
                    html += '<tr><th width="40%" class="text-right">Student Name</th><td width="60%">' + data.patient_first_name + ' ' + data.patient_last_name + '</td></tr>';

                    html += '<tr><th width="40%" class="text-right">Student ID</th><td width="60%">' + data.patient_phone_no + '</td></tr>';

                    html += '<tr><th width="40%" class="text-right">Department</th><td width="60%">' + data.patient_address + '</td></tr>';
