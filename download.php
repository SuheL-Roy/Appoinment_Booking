...
if(isset($_GET["id"]))
{
	...
	foreach($appointment_data as $appointment_row)
	{
		...
		{
			$html .= '<tr><th width="50%" align="right">Student Name:</th><td>'.$patient_row["patient_first_name"].' '.$patient_row["patient_last_name"].'</td></tr>
			<tr><th width="50%" align="right">Student ID:</th><td>'.$patient_row["patient_phone_no"].'</td></tr>
			<tr><th width="50%" align="right">Department:</th><td>'.$patient_row["patient_address"].'</td></tr>';
		}
		...
		$html .= '
			...
			<tr>
				<th width="50%" align="right">Student come into University</th>
